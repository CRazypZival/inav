...
#define CURRENT_METER_DUAL_CALIBRATION_DEFAULT 1
#else
#define CURRENT_METER_DUAL_CALIBRATION_DEFAULT 0
#endif

#ifndef CURRENT_METER_DUAL_LOW_USE_CLI
#define CURRENT_METER_DUAL_LOW_USE_CLI 1
#endif
#define CURRENT_METER_DUAL_LOW_USE_CLI_DEFAULT CURRENT_METER_DUAL_LOW_USE_CLI

#ifndef CURRENT_METER_LOW_SCALE
#define CURRENT_METER_LOW_SCALE CURRENT_METER_SCALE
#endif
#define CURRENT_METER_LOW_SCALE_DEFAULT CURRENT_METER_LOW_SCALE

#ifndef CURRENT_METER_LOW_OFFSET
#define CURRENT_METER_LOW_OFFSET CURRENT_METER_OFFSET
#endif
#define CURRENT_METER_LOW_OFFSET_DEFAULT CURRENT_METER_LOW_OFFSET

#ifndef CURRENT_METER_DUAL_TRANSITION_UV_START
#ifdef CURRENT_METER_DUAL_TRANSITION_MV_START
#define CURRENT_METER_DUAL_TRANSITION_UV_START ((CURRENT_METER_DUAL_TRANSITION_MV_START) * 1000)
#else
#define CURRENT_METER_DUAL_TRANSITION_UV_START 120000
#endif
#endif
#define CURRENT_METER_DUAL_TRANSITION_UV_START_DEFAULT CURRENT_METER_DUAL_TRANSITION_UV_START

#ifndef CURRENT_METER_DUAL_TRANSITION_UV_END
#ifdef CURRENT_METER_DUAL_TRANSITION_MV_END
#define CURRENT_METER_DUAL_TRANSITION_UV_END ((CURRENT_METER_DUAL_TRANSITION_MV_END) * 1000)
#else
#define CURRENT_METER_DUAL_TRANSITION_UV_END 200000
#endif
#endif
#define CURRENT_METER_DUAL_TRANSITION_UV_END_DEFAULT CURRENT_METER_DUAL_TRANSITION_UV_END

#ifndef CURRENT_METER_HIGH_SCALE
#define CURRENT_METER_HIGH_SCALE CURRENT_METER_SCALE
#endif
#define CURRENT_METER_HIGH_SCALE_DEFAULT CURRENT_METER_HIGH_SCALE

#ifndef CURRENT_METER_HIGH_OFFSET
#define CURRENT_METER_HIGH_OFFSET CURRENT_METER_OFFSET
#endif
#define CURRENT_METER_HIGH_OFFSET_DEFAULT CURRENT_METER_HIGH_OFFSET
